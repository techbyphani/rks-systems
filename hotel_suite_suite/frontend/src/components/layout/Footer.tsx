        ...
        <Row gutter={[32, 32]}>
          ...
          <Col xs={24} sm={12} md={6}>
            ...
            <Space direction="vertical" size="small">
              <Link to="/rooms" style={{ color: 'rgba(255, 255, 255, 0.65)', display: 'block' }}>
                Rooms & Suites
              </Link>
              <Link to="/restaurant" style={{ color: 'rgba(255, 255, 255, 0.65)', display: 'block' }}>
                Restaurant
              </Link>
              <Link to="/events" style={{ color: 'rgba(255, 255, 255, 0.65)', display: 'block' }}>
                Events
              </Link>
              <Link to="/gallery" style={{ color: 'rgba(255, 255, 255, 0.65)', display: 'block' }}>
                Gallery
              </Link>
            </Space>
          </Col>
